...
Generates a client and server java keystore that is used to provide client SSL authentication for [Senzing API Server](https://github.com/senzing-garage/senzing-api-server) and [Senzing POC Server](https://github.com/senzing-garage/senzing-poc-server).
...
1. Related artifacts:
    ...
    1. [Helm Chart](https://github.com/senzing-garage/charts/tree/main/charts/senzing-keystore-generator)
